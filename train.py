...
def get_parser():
    ...
    parser.add_argument("--mmlm_steps", type=str, default="",
                        help="Mixed Masked prediction steps (MMLM)")
...
if __name__ == '__main__':
    ...
    # if params.langs[0] =='mix':
    #     params.n_langs = 5 
    #     params.id2lang = {0:'mix', 3:'en', 1:'ms', 2:'zh', 4:'other'}
    #     params.lang2id = {'mix':0, 'en': 3, 'ms': 1, 'zh' : 2, 'other': 4}
